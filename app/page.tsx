...
// МЕНЯЙ ЗДЕСЬ
// МЕНЯЙ ЗДЕСЬ
const FINAL_TEXT = `Машунечка, я тебя люблю. Я буду повторять это тысячи и тысячи раз.
Мы встречаемся уже целый год, и сколько бы ни было ссор и недопониманий, ты всё равно остаёшься самым важным для меня человеком. Ведь только ты можешь согреть меня своей любовью.

Многие люди разочаровываются в своей любви, чем дальше заходят отношения, но я с каждой секундой влюбляюсь в тебя всё сильнее и сильнее. Каждый раз, когда я смотрю на тебя, я понимаю, насколько сильно тебя люблю.

Я люблю тебя невероятно сильно. Спасибо, что ты есть и что делаешь для меня. ❤️`;
  ...
  return (
    <main className="page" onPointerDown={handlePointerDown}>
      ...
      <div className="card">
        ...
        {step === 7 && (
          <section className="stack">
            <p style={{ whiteSpace: "pre-line" }}>{FINAL_TEXT}</p>
            <div className="row">
              <button
                className="btn"
                onClick={() =>
